...
- On setting the shift reference field, it must automatically fetch "branch", set "custom_pea_planned_start_date" and "custom_pea_planned_start_date" from the shift document. Assume that these fields are already available in the stock entry document.
...
- "Operation Details" will have the following fields,
  ...
  - "custom_pea_planned_start_date" (Shift Planned end date time)
